...
<body>
  <form id="defaultForm" method="post" runat="server">
    ...
    <h1>This application was generated by UIGen.exe</h1>
    <p>
      To start the application click 'Start'
      <img class="pfeil" src="Images/arrow.gif" alt="goto"  />&nbsp;<a href="javascript:StartApp('EditLocation.wxe?WxeReturnToSelf=true');">Start</a>
    </p>
	<p>
	  <br/>

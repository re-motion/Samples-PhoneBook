<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditPhoneNumberForm.aspx.cs" Inherits="PhoneBook.Web.UI.EditPhoneNumberForm" %>
<%@ Register TagPrefix="app" TagName="NavigationTabs" Src="NavigationTabs.ascx" %>
<%@ Register TagPrefix="remotion" TagName="EditPhoneNumberControl" Src="EditPhoneNumberControl.ascx" %>
...
<body>
  <form id="EditForm" runat="server">
    ...
    <remotion:TabbedMultiView ID="MultiView" runat="server" CssClass="tabbedMultiView" >
      ...
      <Views>
        <remotion:TabView ID="EditPhoneNumberView" Title="$res:Details" runat="server">
          <remotion:EditPhoneNumberControl ID="EditPhoneNumberControl" runat="server" />
        </remotion:TabView>
      </Views>
      <BottomControls>
